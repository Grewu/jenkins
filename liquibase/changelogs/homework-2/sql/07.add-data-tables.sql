...
INSERT INTO employees (first_name, last_name, position, department_id, email, username, password_hash)
VALUES ('Alice', 'Smith', 'Manager', 1, 'alice.smith@example.com', 'alice', 'password_hash'),
       ('Bob', 'Johnson', 'Developer', 2, 'bob.johnson@example.com', 'bob', 'password_hash'),
       ('Charlie', 'Williams', 'Salesperson', 3, 'charlie.williams@example.com', 'charlie', 'password_hash'),
       ('David', 'Brown', 'Marketing Specialist', 4, 'david.brown@example.com', 'david', 'password_hash');
