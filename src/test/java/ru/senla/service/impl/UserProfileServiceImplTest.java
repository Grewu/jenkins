    ...
    class GetAll {
        ...
        void getAllShouldReturnCommentsByProfileId() {
            ...
            doReturn(commentPage)
                    .when(commentRepository).findCommentsByProfileId(commentId, pageable);
            ...
            // when
            var actualResponses = userProfileService
                    .getAllCommentsByProfileId(commentId, pageable).getContent();
