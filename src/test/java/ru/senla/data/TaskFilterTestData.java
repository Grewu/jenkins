...
public class TaskFilterTestData {
  ...
  @Builder.Default private Long assignedTo = 1L;

  @Builder.Default private Long createdBy = 2L;

  @Builder.Default private Long project = 3L;

  @Builder.Default private LocalDateTime dueDate = LocalDateTime.parse("2024-09-30T12:00:00");
