...
public class TaskHistoryTestData {
    ...
    @Builder.Default
    private String changedDescription = "changedDescription";

    public TaskHistory buildTaskHistory() {
        return new TaskHistory(id, task, name, project, assignedTo, createdBy, dueDate, status, priority,
                changedBy, changedDate, changedDescription);
    }
