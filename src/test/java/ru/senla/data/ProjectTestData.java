...
public class ProjectTestData {
  ...
  @Builder.Default private String projectCode = "projectCode";

  @Builder.Default private String description = "description";

  @Builder.Default private LocalDateTime startDate = LocalDateTime.parse("2024-09-30T12:00:00");

  @Builder.Default private LocalDateTime endDate = LocalDateTime.parse("2024-09-30T12:00:00");
  ...
  public ProjectResponse buildProjectResponse() {
    return new ProjectResponse(
        id, name, projectCode, description, startDate, endDate, owner.getId());
  }
}
