 ...
 * This controller allows clients to create, retrieve, update, and delete project entities and to fetch tasks related to a specific project.
 * Each endpoint has specific authorization requirements and supports JSON responses.
 * It uses {@link ProjectService} to handle the business logic related to project management.
 *
 * <p>Endpoints:</p>
 * <ul>
 *     <li><b>POST /api/v0/projects</b>: Creates a new project.</li>
 *     <li><b>GET /api/v0/projects</b>: Retrieves a paginated list of all projects.</li>
 *     <li><b>GET /api/v0/projects/{id}</b>: Retrieves a specific project by its ID.</li>
 *     <li><b>GET /api/v0/projects/{projectId}/tasks</b>: Retrieves a paginated list of tasks related to a specific project.</li>
 *     <li><b>PUT /api/v0/projects/{id}</b>: Updates a specific project by its ID.</li>
 *     <li><b>DELETE /api/v0/projects/{id}</b>: Deletes a specific project by its ID.</li>
 * </ul>
 *
 * <p>Authorization Requirements:</p>
 * <ul>
 *     <li><b>project:write</b> permission is required for creating and updating projects.</li>
 *     <li><b>project:read</b> permission is required for retrieving projects.</li>
 *     <li><b>task:read</b> permission is required for retrieving tasks related to a project.</li>
 *     <li><b>project:delete</b> permission is required for deleting projects.</li>
 * </ul>
 *
 * @see ProjectRequest
 * @see ProjectResponse
...
public class ProjectRestController {
     ...
     *
     * @param projectRequest the {@link ProjectRequest} object containing details of the project to create.
     * @return a {@link ResponseEntity} containing the created {@link ProjectResponse} with HTTP status 201 (Created).
     */
    @PostMapping
     ...
     *
     * @param pageable the pagination information, with a default page size of 20.
     * @return a {@link ResponseEntity} containing a {@link Page} of {@link ProjectResponse} objects with HTTP status 200 (OK).
     */
    @GetMapping
     ...
     * @return a {@link ResponseEntity} containing the {@link ProjectResponse} with HTTP status 200 (OK).
     */
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority('project:read')")
     ...
     * @param projectRequest the {@link ProjectRequest} object containing updated details of the project.
     * @return a {@link ResponseEntity} containing the updated {@link ProjectResponse} with HTTP status 200 (OK).
     */
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('project:write')")
