...
/**
 * Mapper interface for converting between {@link UserProfile} entities and their corresponding
 * DTOs, {@link UserProfileRequest} and {@link UserProfileResponse}.
 *
...
public interface UserProfileMapper {
  ...
  @Mapping(
      target = "department",
      expression = "java(new Department(userProfileRequest.department()))")
  ...
  /**
   * Updates an existing {@link UserProfile} entity with values from a {@link UserProfileRequest}.
   *
