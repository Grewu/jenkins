...
/**
 * Mapper interface for converting between {@link Comment} entities and their corresponding DTOs,
 * {@link CommentRequest} and {@link CommentResponse}.
 *
...
public interface CommentMapper {
  ...
  @Mapping(
      target = "usersProfile",
      expression = "java(new UserProfile(commentRequest.usersProfile()))")
  ...
  /**
   * Updates an existing {@link Comment} entity with values from a {@link CommentRequest}.
   *
