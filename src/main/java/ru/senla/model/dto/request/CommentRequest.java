 ...
 *
 * <p>This class includes information about a comment, including the associated task, user profile,
 * comment text, and creation timestamp.
 */
public record CommentRequest(
    @NotNull(message = "Task ID must not be null") Long task,
    @NotNull(message = "User profile ID must not be null") Long usersProfile,
