 ...
 *
 * <p>This interface defines the operations for creating, updating, deleting, and retrieving tasks.
 * It extends the {@link AbstractService} for generic CRUD operations and adds task-specific
 * functionality.
 */
