 ...
 *
 * <p>This interface extends {@link AbstractService} to provide basic CRUD operations for user
 * profiles, as well as additional functionalities related to user comments.
 */
public interface UserProfileService
    extends AbstractService<Long, UserProfileRequest, UserProfileResponse> {
  /**
   ...
   * @return a {@link Page} of {@link CommentResponse} containing the comments for the specified
   *     user profile
   */
