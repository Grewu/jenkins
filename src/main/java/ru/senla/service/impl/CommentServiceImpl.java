 ...
 * to provide business logic for managing comments. It handles the creation,
 * retrieval, updating, and deletion of comments while ensuring transactional integrity.
 * The service uses a CommentMapper to convert between entity and DTO objects.
 *
 * <p>This service requires interaction with the following repositories:</p>
 * <ul>
 *     <li>CommentRepository: For CRUD operations on comments.</li>
 *     <li>UserProfileRepository: For retrieving user profile data related to comments.</li>
 *     <li>TaskRepository: For retrieving task data related to comments.</li>
 * </ul>
 *
 * @see CommentService
 * @see CommentMapper
...
public class CommentServiceImpl implements CommentService {
     ...
     * @throws EntityNotFoundException if the comment or related entities (UserProfile, Task) do not exist.
     */
    @Override
    @Transactional
    public CommentResponse update(Long id, CommentRequest commentRequest) {
        ...
        var userProfile = userProfileRepository.findById(commentRequest.usersProfile())
                .orElseThrow(() -> new EntityNotFoundException(UserProfile.class, commentRequest.usersProfile()));
