...
/**
 * The DepartmentServiceImpl class implements the DepartmentService interface to provide business
 * logic for managing departments. It handles the creation, retrieval, updating, and deletion of
 * departments while ensuring transactional integrity. The service uses a DepartmentMapper to
 * convert between entity and DTO objects and a UserProfileMapper to manage user profiles associated
 * with departments.
 *
...
public class DepartmentServiceImpl implements DepartmentService {
   ...
   *
   * @param departmentRequest the request object containing the details of the department to be
   *     created.
