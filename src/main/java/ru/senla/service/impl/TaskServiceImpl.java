...
/**
 * Implementation of the TaskService interface for managing tasks. Provides CRUD operations for
 * tasks, task history, and scheduled notifications for due dates.
 */
@Service
...
public class TaskServiceImpl implements TaskService {
  ...
  public Page<TaskResponse> getAllByFilter(TaskFilter taskFilter, Pageable pageable) {
    return taskRepository
        .findAll(TaskSpecificationGenerator.filterToSpecification(taskFilter), pageable)
  ...
  public Page<TaskHistoryResponse> getAllTaskHistory(Long taskId, Pageable pageable) {
    return taskHistoryRepository
        .findTaskHistoryByTaskId(taskId, pageable)
