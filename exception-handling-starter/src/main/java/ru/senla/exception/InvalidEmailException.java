...
/**
 * The {@code InvalidEmailException} class represents an exception
 * that is thrown when an invalid email address is encountered in
 * the application.
 *
 * <p>
 * This exception extends {@code AbstractExceptionMessageException}
 * and provides a specific message indicating the invalid email
...
public class InvalidEmailException extends AbstractExceptionMessageException {
    ...
    /**
     * Constructs a new {@code InvalidEmailException} with the
     * specified invalid email address.
     *
