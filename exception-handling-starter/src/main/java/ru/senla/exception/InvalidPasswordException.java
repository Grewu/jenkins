...
/**
 * The {@code InvalidPasswordException} class represents an exception
 * that is thrown when an invalid password is encountered in
 * the application.
 *
 * <p>
 * This exception extends {@code AbstractExceptionMessageException}
 * and provides a specific message indicating the invalid password
...
public class InvalidPasswordException extends AbstractExceptionMessageException {
    ...
    /**
     * Constructs a new {@code InvalidPasswordException} with the
     * specified invalid password.
     *
