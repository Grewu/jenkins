...
/**
 * The {@code EntityNotFoundException} class represents an exception
 * that is thrown when a requested entity is not found in the
 * system.
 *
 * <p>
 * This exception extends {@code AbstractExceptionMessageException}
 * and provides specific messages indicating the entity type
 * and the identifier or field value that could not be found.
 * </p>
 */
public class EntityNotFoundException extends AbstractExceptionMessageException {
    ...
    /**
     * Constructs a new {@code EntityNotFoundException} for an
     * entity of the specified class with the given ID.
     *
    ...
    /**
     * Constructs a new {@code EntityNotFoundException} for an
     * entity of the specified class with the given field value.
     *
     * @param entity     the class of the entity that was not found
     ...
     * which is {@code HttpStatus.NOT_FOUND}.
     *
